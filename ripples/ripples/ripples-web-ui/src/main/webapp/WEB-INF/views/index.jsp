...
<head>
    ...
    <link href="../static/assets/apps/css/inbox.min.css" rel="stylesheet" type="text/css" />
    ...
    <link rel="stylesheet" href="../static/assets/apps/css/shutter.css">
    <%--动态--%>
                    ...
                    <div class="container" >
                        ...
                        <div class="top-menu">
                            <ul class="nav navbar-nav pull-right" >
                                ...
                                <li class="dropdown dropdown-extended dropdown-notification dropdown-dark ${sessionScope.user!= null ? '':'hidden'}" id="header_notification_bar">
                                    <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                        <i class="icon-bell"></i>
                                ...
                                <li class="dropdown dropdown-extended dropdown-inbox dropdown-dark ${sessionScope.user!= null ? '':'hidden'}" id="header_inbox_bar" >
                                    <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                ...
                                <li class="dropdown dropdown-user dropdown-dark ${sessionScope.user!= null ? '':'hidden'}">
                                    <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
...
<script src="../static/assets/apps/scripts/inbox.min.js" type="text/javascript"></script>
