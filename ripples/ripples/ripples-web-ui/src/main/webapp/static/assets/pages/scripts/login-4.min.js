    ...
    var e = function() {
        ...
        s = function() {
            function e(e) {
                ...
                var r = $('<span><img src="/static/assets/global/img/flags/' + e.element.value.toLowerCase() + '.png" class="img-flag" /> ' + e.text + "</span>");
                return r
            }
    ...
    return {
        init: function() {
            e(),
                r(),
                s(),
                $.backstretch(["/static/assets/pages/media/bg/1.jpg", "/static/assets/pages/media/bg/2.jpg", "/static/assets/pages/media/bg/3.jpg", "/static/assets/pages/media/bg/4.jpg"], {
                    fade: 1e3,
                    duration: 8e3
                })
        }
